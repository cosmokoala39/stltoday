...
<div className="d-flex gap-2 mb-4">
  ...
  <button className="btn btn-info btn-sm"><i className="bi bi-bug-fill"></i></button> {/* Replace with real icon */}
    ...
    <div className="d-flex align-items-center gap-2 ms-2 text-muted small">
      ...
      <span className="border rounded px-1">1.0x</span>
          ...
          <div className="article-text text-black">
            ...
            <p>Some cards offer a 0% intro APR on transferred balances for 12 to 18 months. That can be game changer if you qualify.</p>
          ...
          <div className="text-center mt-5 pt-4 border-top">
            ...
            <p className="text-muted small mb-0">
              * I understand and agree that registration on or use of this site constitutes agreement to its <a href="#">user agreement</a> and <a href="#">privacy policy</a>.
            </p>
          </div>
        </div>
      </div>
