        ...
        <div className="row">
          ...
          <div className="col-md-4 mb-4">
            ...
            <div className="d-flex gap-3 mt-3">
              ...
              <i className="bi bi-cloud-fill fs-5 text-light"></i> {/* Placeholder for Bluesky */}
            ...
            <ul className="list-unstyled small mt-3">
              <li><a href="/" className="text-light text-decoration-none">Feast Magazine</a></li>
              <li><a href="/" className="text-light text-decoration-none">Ladue News</a></li>
              <li><a href="/" className="text-light text-decoration-none">STL High School Sports</a></li>
              <li><a href="/" className="text-light text-decoration-none">STL Pinch Hits</a></li>
            </ul>
          </div>
...
<div className="d-flex flex-column flex-md-row justify-content-between align-items-start text-light small px-2">
  ...
  <div>
    ...
    <br />
    <a href="/" className="text-light text-decoration-none me-2">Terms of Use</a> |
    <a href="/" className="text-light text-decoration-none mx-2">Privacy Policy</a> |
    <a href="/" className="text-light text-decoration-none mx-2">Advertising Terms</a> |
    <a href="/" className="text-light text-decoration-none mx-2">Do Not Sell My Info</a> |
    <a href="/" className="text-light text-decoration-none">Cookie Preferences</a>
  </div>
